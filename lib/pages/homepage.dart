  ...
  void startVoiceDetection() async {
    await _voiceService.startListening((text) async {
      ...
      if (text.contains("help") || text.contains("scream")) {
        ...
        var location = await LocationService().getCurrentLocation();
        String emergencyMessage = "Emergency! Location: ${location?.latitude}, ${location?.longitude}";
...
// }
  ...
  body: Center(  // Ensure 'body:' is properly defined
    child: Column(
